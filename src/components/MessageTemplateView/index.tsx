    ...
    <div className="container mx-auto max-w-3xl">
      <div className="bg-white border m-4 p-4">
        <div className="border-b pb-2 mb-4">
          <h2 className="text-xl">{messateTemplateId ? 'Editar modelo de mensagem' : 'Criar modelo de mensagem'}</h2>
        </div>
...
function TagParam({ children, onClick }: PropsWithChildren & Pick<DOMAttributes<HTMLElement>, 'onClick'>) {
  ...
  return <p onClick={onClick} className="bg-slate-400 text-white py-2 px-3 rounded m-2">{children}</p>;
}